  ...
  <div class="col-md-12">
    <div class="row">
        <div class="col-sm-5" id="part">
          <h1 class="text-white addRestaurantheading">Customers are waiting for the food.</h1>
        </div>
        <div class="col-sm-7">
              <h1 class="lead display-4">Add Food</h1>
              <br>
              <div class="card">
                <div class="card-body">
                  <form action="../process/loginRestaurant.php" method="post" autocomplete="off">
                  ...
                  <div class="form-group text-center">
                    <button type="submit"class="btn btn-info btn-lg" name="login">Submit</button>
                    <br>
                    <br>
                    <a href="addRestaurant.php" class="text-muted">Add Restaurant</a>
                  </div>
                  </form>
                </div>
              </div>
