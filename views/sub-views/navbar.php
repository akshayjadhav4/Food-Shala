<nav class="navbar  navbar-expand-lg navbar-dark bg-dark">
            <span class="navbar-brand mb-0 h1">Food Shala</span>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item"><a class="nav-link" href="../views/customerDashboard.php">Account</a></li>
                <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="../views/loginRestaurant.php">Add Food</a></li>
