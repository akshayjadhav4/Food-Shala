  ...
  <div class="col-md-12">
    <div class="row">
        <div class="col-sm-5" id="part">
          <h1 class="text-white addRestaurantheading">Sign up for lightning fast delivery to your customers</h1>
        </div>
        <div class="col-sm-7">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group text-center">
                    ...
                    <br>
                    <br>
                    <a href="loginRestaurant.php" class="text-muted">Already have an account!</a>
                  </div>
                  </form>
                </div>
              </div>
